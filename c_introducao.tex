...
Com isso em mente o trabalho aqui proposto se dispõem em testar o método de intervalo de confiança, como uma alternativa aos métodos tradicionais para obtenção de dados provindos de sensores sem interferência de ruídos, com dados coletados de sensores conectados aos processador ESP32 no sistema operacional de tempo real \cite{Zephyr}.
...
% O escopo desta pesquisa abrange a utilização do método de intervalo de confiança móvel para a filtragem de dados indesejáveis vindo de sensores diversos em tempo real de execução, tendo como característica atuar de forma amigável junto a um sistema operacional de tempo real. Assim, em um primeiro momento considerou-se desenvolver e testar as funções sobre o microprocessador ESP32 da fabricante Espressif, em conjunto com o sistema operacional Zephyr um projeto mantido pela fundação Linux.

% O escopo desta pesquisa abrange um conjunto de funções escritas na linguagem C para a filtragem de dados indesejáveis vindos de sensores diversos, funções quais... % TODO: Inserir métodos e pesquisas relevantes.
